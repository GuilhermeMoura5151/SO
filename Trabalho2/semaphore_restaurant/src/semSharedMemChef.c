 ...
 */
static void waitForOrder () //empregado faz arrancar esta funcao
{

    //TODO insert your code here

    // waitOrder-identification of semaphore used by chef to wait for order – val = 0
    ...
    //Mudar estado do cozinheiro para COOK (cozinhando)
 ...
 */
static void processOrder () // Depois de cozinhar chama waiter ( Apenas se ele tiver apto)
{
    ...
    //Comida entregue ao WAITER, cozinheiro volta a esperar por nova order
